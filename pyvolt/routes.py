...
# Channels control
CHANNELS_CHANNEL_ACK: typing.Final[Route] = Route(
...
CHANNELS_GROUP_ADD_MEMBER: typing.Final[Route] = Route(
    "PUT", "/channels/{channel_id}/recipients/{user_id}"
)
CHANNELS_GROUP_CREATE: typing.Final[Route] = Route("POST", "/channels/create")
CHANNELS_GROUP_REMOVE_MEMBER: typing.Final[Route] = Route(
    "DELETE", "/channels/{channel_id}/recipients/{user_id}"
)
CHANNELS_INVITE_CREATE: typing.Final[Route] = Route(
    "POST", "/channels/{channel_id}/invites"
)
CHANNELS_MEMBERS_FETCH: typing.Final[Route] = Route(
    "GET", "/channels/{channel_id}/members"
)
CHANNELS_MESSAGE_BULK_DELETE: typing.Final[Route] = Route(
    "DELETE", "/channels/{channel_id}/messages/bulk"
)
CHANNELS_MESSAGE_CLEAR_REACTIONS: typing.Final[Route] = Route(
    "DELETE", "/channels/{channel_id}/messages/{message_id}/reactions"
)
CHANNELS_MESSAGE_DELETE: typing.Final[Route] = Route(
    "DELETE", "/channels/{channel_id}/messages/{message_id}"
)
CHANNELS_MESSAGE_EDIT: typing.Final[Route] = Route(
    "PATCH", "/channels/{channel_id}/messages/{message_id}"
)
CHANNELS_MESSAGE_FETCH: typing.Final[Route] = Route(
    "GET", "/channels/{channel_id}/messages/{message_id}"
)
CHANNELS_MESSAGE_QUERY: typing.Final[Route] = Route(
    "GET", "/channels/{channel_id}/messages"
)
CHANNELS_MESSAGE_REACT: typing.Final[Route] = Route(
    "PUT", "/channels/{channel_id}/messages/{message_id}/reactions/{emoji}"
)
CHANNELS_MESSAGE_PIN: typing.Final[Route] = Route(
    "POST", "/channels/{channel_id}/messages/{message_id}/pin"
)
CHANNELS_MESSAGE_SEND: typing.Final[Route] = Route(
    "POST", "/channels/{channel_id}/messages"
)
CHANNELS_MESSAGE_UNPIN: typing.Final[Route] = Route(
    "POST", "/channels/{channel_id}/messages/{message_id}/unpin"
)
CHANNELS_MESSAGE_SEARCH: typing.Final[Route] = Route(
...
CHANNELS_PERMISSIONS_SET: typing.Final[Route] = Route(
    "PUT", "/channels/{channel_id}/permissions/{role_id}"
)
CHANNELS_PERMISSIONS_SET_DEFAULT: typing.Final[Route] = Route(
    "PUT", "/channels/{channel_id}/permissions/default"
)
CHANNELS_VOICE_JOIN: typing.Final[Route] = Route(
    "POST", "/channels/{channel_id}/join_call"
)
CHANNELS_WEBHOOK_CREATE: typing.Final[Route] = Route(
    "POST", "/channels/{channel_id}/webhooks"
)
CHANNELS_WEBHOOK_FETCH_ALL: typing.Final[Route] = Route(
    "GET", "/channels/{channel_id}/webhooks"
)


# Customization control (emojis)
CUSTOMISATION_EMOJI_CREATE: typing.Final[Route] = Route(
    "PUT", "/custom/emoji/{attachment_id}"
)
CUSTOMISATION_EMOJI_DELETE: typing.Final[Route] = Route(
    "DELETE", "/custom/emoji/{emoji_id}"
)
CUSTOMISATION_EMOJI_FETCH: typing.Final[Route] = Route(
...
WEBHOOKS_WEBHOOK_DELETE_TOKEN: typing.Final[Route] = Route(
    "DELETE", "/webhooks/{webhook_id}/{webhook_token}"
)
WEBHOOKS_WEBHOOK_EDIT: typing.Final[Route] = Route("PATCH", "/webhooks/{webhook_id}")
WEBHOOKS_WEBHOOK_EDIT_TOKEN: typing.Final[Route] = Route(
    "PATCH", "/webhooks/{webhook_id}/{webhook_token}"
)
WEBHOOKS_WEBHOOK_EXECUTE: typing.Final[Route] = Route(
    "POST", "/webhooks/{webhook_id}/{webhook_token}"
)
WEBHOOKS_WEBHOOK_FETCH: typing.Final[Route] = Route("GET", "/webhooks/{webhook_id}")
WEBHOOKS_WEBHOOK_FETCH_TOKEN: typing.Final[Route] = Route(
    "GET", "/webhooks/{webhook_id}/{webhook_token}"
)

# Account Authentication
AUTH_ACCOUNT_CHANGE_EMAIL: typing.Final[Route] = Route(
    "PATCH", "/auth/account/change/email"
)
AUTH_ACCOUNT_CHANGE_PASSWORD: typing.Final[Route] = Route(
    "PATCH", "/auth/account/change/password"
)
AUTH_ACCOUNT_CONFIRM_DELETION: typing.Final[Route] = Route(
...
AUTH_ACCOUNT_DISABLE_ACCOUNT: typing.Final[Route] = Route(
    "POST", "/auth/account/disable"
)
AUTH_ACCOUNT_FETCH_ACCOUNT: typing.Final[Route] = Route("GET", "/auth/account/")
AUTH_ACCOUNT_PASSWORD_RESET: typing.Final[Route] = Route(
    "PATCH", "/auth/account/reset_password"
)
AUTH_ACCOUNT_RESEND_VERIFICATION: typing.Final[Route] = Route(
    "POST", "/auth/account/reverify"
)
AUTH_ACCOUNT_SEND_PASSWORD_RESET: typing.Final[Route] = Route(
    "POST", "/auth/account/reset_password"
)
AUTH_ACCOUNT_VERIFY_EMAIL: typing.Final[Route] = Route(
